...
<div class="container">
  	<div class="panel panel-default">
		<form action="{!! URL::to('status/search') !!}" method="post">
		...
		<table class="table table-stripped table-bordered">
			...
			@foreach ($orders as $o => $val)
				...
				<tr>
					<td> {!! date('d F Y, H:i:s', strtotime($val->date)) !!}</td>
					<td>  {!! ucwords($otr[0]) !!}</td>
					...
					<td class="text-center">
						<div class="btn-group">
							<a href="edit/{{ $val->orders_code }}" class="btn btn-sm btn-default" title="View" data-toggle="tooltip"><i class="glyphicon glyphicon-edit"></i></a>
						</div>
					</td>
				</tr>
